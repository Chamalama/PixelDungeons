...
@Getter
@Setter
public class TeamDungeonRoomCompleteEvent extends Event implements Cancellable {
    ...
    public TeamDungeonRoomCompleteEvent(DungeonTeamWrapper dungeonTeamWrapper) {
